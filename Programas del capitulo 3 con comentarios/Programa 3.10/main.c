...
//For comienza con I igual a 1 y continúa hasta que I sea menor o igual a N, donde N es el número de datos ingresados por el usuario. I se incrementa en 1, for compila los numero enteros, suma los pares y calcula el promedio de los impares
