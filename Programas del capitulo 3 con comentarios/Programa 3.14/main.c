...
/* Elección.
El programa obtiene el total de vots de cada candidato y el procentaje correspondiente. Tambien considera votos nulos.
...
// Aqui While continua hasta que el valor de VOT sea diferente a 0, While recoge los votos y cuenta el numero de votos para cada candidato y los votos nulos hasta que se ingrese 0, se calculan los votos para cada uno y se imprimen los resultados
