...
void main (void)
{
    ...
    /* Observa que la condición es verdadera mientras el pago es diferente de cero. */
    {
        ...
        scanf("%f", &PAG);
        /* Observa que la promoción que modifica la condición es una lectura. */
    }
    printf("\nEl total de pagos del mes es: %.2f", SPA);
}


// La funcion de While aqui es compilar los pagos y calcular el total hasta que se ingrese un pago de 0
